...
/*	CREATE TABLE PROD_LIST( PKID int IDENTITY(1,1) NOT NULL,
		      ID int NOT NULL,CODE varchar(20) NULL,NAME varchar(50) NOT NULL,LINK varchar(30) NOT NULL,
		      PRICE money NULL,EAN varchar(30) NULL,PICT image NULL,GRUPA int NULL )		      */
	...
	class DbHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			String sql = String.format("create table %s " + 
					...
					TABLE, C_PKID, C_ID, C_GRUPA, C_NAME);			
